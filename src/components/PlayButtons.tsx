      ...
      <motion.div className="absolute top-0 left-0 grid place-items-center h-full w-full">
        {advanced ? (
          <div className="h-full w-[360px] grid grid-rows-3">
            <Button
              onClick={() => onClick(0)}
              className="rounded-[50%] w-[100px] h-[100px] relative bg-white !visible justify-self-center bg-gradient-to-r from-purple-500 to-pink-500"
              lid="rock"
            >
            ...
            <Button
              onClick={() => onClick(1)}
              className="rounded-[50%] w-[100px] h-[100px] relative bg-white !visible justify-self-end bg-gradient-to-r from-sky-500 to-indigo-500"
              lid="paper"
            >
            ...
            <Button
              onClick={() => onClick(2)}
              className="rounded-[50%] w-[100px] h-[100px] relative bg-white !visible justify-self-start -mt-24 bg-gradient-to-r from-yellow-500 to-orange-500"
              lid="scissors"
            >
            ...
            <Button
              onClick={() => onClick(3)}
              className="rounded-[50%] w-[100px] h-[100px] relative bg-white !visible justify-self-end mr-10 bg-gradient-to-r from-purple-500 to-indigo-500"
              lid="lizard"
            >
            ...
            <Button
              onClick={() => onClick(4)}
              className="rounded-[50%] w-[100px] h-[100px] relative bg-white !visible -mt-24 ml-10 bg-gradient-to-r from-green-500 to-teal-500"
              lid="spock"
            >
